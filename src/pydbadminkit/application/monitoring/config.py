...
class HealthCheckConfig:
    ...
    long_transactions_seconds: Threshold = field(default_factory=lambda: Threshold(60.0, 600.0))
    idle_transactions_seconds: Threshold = field(default_factory=lambda: Threshold(60.0, 300.0))
